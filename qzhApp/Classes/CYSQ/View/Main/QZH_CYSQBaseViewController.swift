//
//  QZH_CYSQBaseViewController.swift
//  qzhApp
//
...
class QZH_CYSQBaseViewController: UIViewController {
    /// 访客视图字典信息
...
// MARK: - 设置界面
extension QZH_CYSQBaseViewController{
    func setupUI(){
...
extension QZH_CYSQBaseViewController:UITableViewDataSource,UITableViewDelegate{
