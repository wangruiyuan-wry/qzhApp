...
class QZH_CYSQHomeHotSell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        line1.text=""
        line1.dividers(0, y: 500*PX, width: SCREEN_WIDTH, height: 1*PX, color: myColor().grayF0())
        
        line2.text = ""
        line2.dividers(374*PX, y: 0, width: 2*PX, height: 500*PX, color: myColor().grayF0())
        
        img1.frame = CGRect(x:20*PX,y:20*PX,width:334*PX,height:334*PX)
        img1.image = UIImage(named:"loadPic")
        
        img2.frame = CGRect(x:396*PX,y:20*PX,width:334*PX,height:334*PX)
        img2.image = UIImage(named:"loadPic")
        
        zy1.setLabelView(20*PX, 370*PX, zy1.autoLabelWidth(zy1.text!, font: 18, height: 23*PX), 23*PX, NSTextAlignment.center, UIColor(red:255/255,green:231/255,blue:243/255,alpha:1), UIColor(red:255/255,green:0/255,blue:0/255,alpha:1), 18, "自营")
        ...
        zy2.setLabelView(396*PX, 370*PX, zy2.autoLabelWidth(zy2.text!, font: 18, height: 23*PX), 23*PX, NSTextAlignment.center, UIColor(red:255/255,green:231/255,blue:243/255,alpha:1), UIColor(red:255/255,green:0/255,blue:0/255,alpha:1), 18, "自营")
        ...
        name1.setLabelView(zy1.x+zy1.width + 5*PX, 364*PX, 273*PX, 70*PX, NSTextAlignment.left, UIColor.clear, myColor().gray3(), 24, "")
        if zy1.text == ""{
            zy1.isHidden = true
            name1.x = 43*PX
        }
        name2.setLabelView(zy2.x+zy2.width + 5*PX, 364*PX, 273*PX, 70*PX, NSTextAlignment.left, UIColor.clear, myColor().gray3(), 24, "")
        if zy2.text == ""{
            zy2.isHidden = true
            name2.x = 411*PX
        }
        
        icon1.setLabelView(20*PX, 448*PX, 20*PX, 28*PX, NSTextAlignment.center, UIColor.clear, myColor().redFf4300(), 20, "¥")
        icon2.setLabelView(396*PX, 448*PX, 20*PX, 28*PX, NSTextAlignment.center, UIColor.clear, myColor().redFf4300(), 20, "¥")
        ...
        price2.setLabelView(416*PX, 440*PX, price2.autoLabelWidth(price2.text!, font: 28, height: 40*PX), 40*PX, NSTextAlignment.center, UIColor.clear, myColor().redFf4300(), 28, "")
        ...
        view1.setupViews(x: 20*PX, y: 20*PX, width: 374*PX, height: 500*PX, bgColor: UIColor.clear)
        view2.setupViews(x: 374*PX, y: 20*PX, width: 374*PX, height: 500*PX, bgColor: UIColor.clear)
    }
